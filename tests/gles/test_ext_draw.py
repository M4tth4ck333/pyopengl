...
from OpenGL.GLES3 import (
    ...
    GL_FLOAT, GL_FALSE, GL_TRIANGLES, GL_UNSIGNED_INT, GL_COLOR_ATTACHMENT0,
...
class TestDrawExtensions(ESTestCase):
    ...
    def test_ext_draw_instanced(self):
        ...
        with self.exercise():
            ...
            draw_instanced.glDrawElementsInstancedEXT(GL_TRIANGLES, 3, GL_UNSIGNED_INT, None, 2)
    ...
    def test_oes_draw_elements_base_vertex(self):
        ...
        with self.exercise():
            oes_debv.glDrawElementsBaseVertexOES(GL_TRIANGLES, 3, GL_UNSIGNED_INT, None, 0)

...
from OpenGL.GLES2 import (
    ...
    GL_DITHER, GL_SAMPLE_COVERAGE, GL_POLYGON_OFFSET_FILL,
    GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_ONE, GL_ZERO,
    GL_FUNC_ADD, GL_FUNC_SUBTRACT,
    GL_LESS, GL_LEQUAL, GL_ALWAYS, GL_KEEP, GL_REPLACE,
    GL_FRONT, GL_BACK, GL_FRONT_AND_BACK, GL_CW, GL_CCW,
    GL_GENERATE_MIPMAP_HINT, GL_NICEST, GL_FASTEST,
    ...
    glCullFace, glFrontFace, glDepthFunc, glDepthMask, glDepthRangef,
    glHint, glLineWidth, glPixelStorei, glPolygonOffset, glSampleCoverage,
    glScissor,
    glStencilFunc, glStencilFuncSeparate, glStencilMask, glStencilMaskSeparate,
    glStencilOp, glStencilOpSeparate,
    glFinish, glFlush, glGetBooleanv, glGetFloatv,
    GL_DEPTH_WRITEMASK, GL_LINE_WIDTH,
)
...
class TestES2State(ESTestCase):
    ...
    def test_capabilities(self):
        for cap in (
            ...
            GL_SCISSOR_TEST, GL_DITHER, GL_SAMPLE_COVERAGE, GL_POLYGON_OFFSET_FILL,
        ):
            glEnable(cap)
